...
export default function WelcomeScreen2() {
  ...
  return (
    <ImageBackground
      ...
      />
       <View style={{width:"100%",position:"absolute",bottom:wp(9),flexDirection:"row",justifyContent:"space-between",alignItems:"center",paddingHorizontal:wp(5)}}>
          <AppButton onPress={()=>{}} title="Sign up" buttonStyles={{width:wp("30%")}} textStyles={{fontSize:getFontSize(16)}}/>
          <AppButton onPress={()=>{}} title="Sign in" buttonStyles={{width:wp("30%")}} textStyles={{fontSize:getFontSize(16)}}/>
        </View>
      </View>
    </ImageBackground>
  );
